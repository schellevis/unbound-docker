...
- [`1.26.0`, `latest` (*1.26.0/Dockerfile*)](https://github.com/schellevis/unbound-docker/tree/master/1.26.0)
- [`1.25.1`, (*1.25.1/Dockerfile*)](https://github.com/schellevis/unbound-docker/tree/master/1.25.1)
...
By default, this image forwards queries Cloudflare DNS server over TLS. In other words, it does not act as a recursive server. The [unbound.sh file](1.26.0/data/unbound.sh) provides the configuration unless it is overriden as described below.

*Note: The example [unbound.conf](unbound.conf) file is different from the one set by [unbound.sh file](1.26.0/data/unbound.sh). The example is provided to help you re-configure this as a [recursive server](https://github.com/schellevis/unbound-docker#recursive-config).*

### Override default forward

By default, forwarders are configured to use Cloudflare DNS. You can retrieve the configuration in the [forward-records.conf](1.26.0/data/opt/unbound/etc/unbound/forward-records.conf) file.
...
services:
  unbound:
    ...
    image: "ghcr.io/schellevis/unbound:1.26.0"
    expose:
      - "53"
    networks:
      - dns
...
Documentation for this image is stored right here in the [`README.md`](https://github.com/schellevis/unbound-docker/blob/master/README.md).
...
through a [GitHub issue](https://github.com/schellevis/unbound-docker/issues).
...
file](https://github.com/schellevis/unbound-docker/blob/master/README.md)
before attempting a pull request.

Before you start to code, I recommend discussing your plans through a [GitHub
issue](https://github.com/schellevis/unbound-docker/issues), especially for
...
file](https://github.com/schellevis/unbound-docker/blob/master/LICENSE) for
details.
